...
@section('admin')
 ...
 <div class="content-wrapper">
  ...
  <div class="box-header with-border">
	<h3 class="box-title">Student Exam Type List</h3>
	<a href="{{ route('exam.type.add') }}" style="float: right;" class="btn btn-rounded btn-success mb-5"> Add Student Exam Type</a>			  
				</div>
				<!-- /.box-header -->
		<div class="box-body">
