...
<div class="box bb-3 border-warning">
  ...
  <div class="row">  <!-- start 1st row -->
   ...
   <img src="{{ url('uploads/easyschool.png') }}" style="width: 120px; height: 100px;">			
  		</div>
...
@php
  $grade_marks = App\Models\GradePoint::where([['start_marks','<=', (int)$get_mark],['end_marks', '>=',(int)$get_mark ]])->first();
...
$grde_point_total = App\Models\GradePoint::where([['start_point','<=',
$point_for_letter_grade],['end_point','>=',$point_for_letter_grade]])->first();
